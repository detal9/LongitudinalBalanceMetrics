...
a_1 = as.numeric(rbinom(n,size=1,plogis(-2.95+0.69*a_0+l_1+m_1+
                                          0.1*n_1+2*o_1+2*p_1+0.4*q_1)));

Y = as.numeric(rbinom(n,size=1,plogis(-4.07-0.69*a_0+0.5*l_0+0.5*m_0
...
Y.00 = as.numeric(rbinom(n,size=1,plogis(-4.07-0.69*0+0.5*l_0+0.5*m_0
                                         +0.05*n_0+o_0+p_0+0.2*q_0
                                         -0.69*0+0.5*l_1.0+0.5*m_1.0+0.05*n_1.0
                                         +o_1.0+p_1.0+0.2*q_1)));

Y.01 = as.numeric(rbinom(n,size=1,plogis(-4.07-0.69*0+0.5*l_0+0.5*m_0
                                         +0.05*n_0+o_0+p_0+0.2*q_0
                                         -0.69*1+0.5*l_1.0+0.5*m_1.0+0.05*n_1.0
                                         +o_1.0+p_1.0+0.2*q_1)));

Y.10 =as.numeric(rbinom(n,size=1,plogis(-4.07-0.69*1+0.5*l_0+0.5*m_0
                                        +0.05*n_0+o_0+p_0+0.2*q_0
                                        -0.69*0+0.5*l_1.1+0.5*m_1.1+0.05*n_1.1
                                        +o_1.1+p_1.1+0.2*q_1)));

Y.11 = as.numeric(rbinom(n,size=1,plogis(-4.07-0.69*1+0.5*l_0+0.5*m_0
                                         +0.05*n_0+o_0+p_0+0.2*q_0
