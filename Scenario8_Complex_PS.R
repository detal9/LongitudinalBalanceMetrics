##################################################################################################################################
#  Scénario 3 de l'article de Franklin en utilisant le DAG de l'article
...
# et dans le modèle d'exposition
#                                                                     
###################################################################################################################################
...
a_0 = as.numeric(rbinom(n,1,plogis(-1.14+0.05*l_0+0.05*m_0+0.1*n_0+0.5*o_0+
                      0.25*p_0+0.4*q_0+0.01*r_0+0.02*u_0+0.01*v_0+0.1*t_0)));
...
a_1 = as.numeric(rbinom(n,size=1,plogis(-1.5+0.69*a_0+0.05*l_1+0.05*m_1+0.1*n_1+0.5*o_1+0.25*p_1+0.4*q_1
