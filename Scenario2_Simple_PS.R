...
a_0 = as.numeric(rbinom(n,1,plogis(-3.08+0.05*l_0+0.05*m_0+0.1*n_0+0.75*o_0+0.5*p_0+0.4*q_0)));
...
a_1 = as.numeric(rbinom(n,size=1,plogis(-3.37+0.69*a_0+0.05*l_1+0.05*m_1+0.1*n_1+0.75*o_1+0.5*p_1+0.4*q_1)));

Y = as.numeric(rbinom(n,size=1,plogis(-5.1-0.69*a_0+0.5*l_0+0.5*m_0
...
l_1.0=as.numeric(0+rnorm(n,0,1)); 
l_1.1=as.numeric(-1+rnorm(n,0,1));
m_1.0=as.numeric(-0.5*0+rlnorm(n,0,0.5));
m_1.1=as.numeric(-0.5*1+rlnorm(n,0,0.5));
n_1.0= as.numeric(-0.25*0+rnorm(n,0,10));
n_1.1= as.numeric(-0.25*1+rnorm(n,0,10));
...
Y.00 = as.numeric(rbinom(n,size=1,plogis(-5.1-0.69*0+0.5*l_0+0.5*m_0
                                         +0.05*n_0+o_0+p_0+0.2*q_0
                                         -0.69*0+0.5*l_1.0+0.5*m_1.0+0.05*n_1.0
                                         +o_1.0+p_1.0+0.2*q_1)));

Y.01 = as.numeric(rbinom(n,size=1,plogis(-5.1-0.69*0+0.5*l_0+0.5*m_0
                                         +0.05*n_0+o_0+p_0+0.2*q_0
                                         -0.69*1+0.5*l_1.0+0.5*m_1.0+0.05*n_1.0
                                         +o_1.0+p_1.0+0.2*q_1)));

Y.10 =as.numeric(rbinom(n,size=1,plogis(-5.1-0.69*1+0.5*l_0+0.5*m_0
                                        +0.05*n_0+o_0+p_0+0.2*q_0
                                        -0.69*0+0.5*l_1.1+0.5*m_1.1+0.05*n_1.1
                                        +o_1.1+p_1.1+0.2*q_1)));

Y.11 = as.numeric(rbinom(n,size=1,plogis(-5.1-0.69*1+0.5*l_0+0.5*m_0
                                         +0.05*n_0+o_0+p_0+0.2*q_0
                                         -0.69*1+0.5*l_1.1+0.5*m_1.1+0.05*n_1.1
                                         +o_1.1+p_1.1+0.2*q_1)));
