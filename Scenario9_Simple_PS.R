...
for(i in 1:B){
  ...
  mod.dnom1 = glm(a_0~l_0+m_0+n_0+p_0+q_0,
                  family=binomial(link = "logit"));
  
  dnom1 =ifelse(a_0== 0, 1-predict(mod.dnom1, type = "response"),
                predict(mod.dnom1, type = "response")) 
  
  mod.dnom2 = glm(a_1~l_0+m_0+n_0+p_0+q_0+
                    l_1+m_1+n_1+p_1+q_1+a_0,
                  family=binomial(link = "logit"));
  
  dnom2=ifelse(a_1== 0, 1-predict(mod.dnom2, type = "response"),
               predict(mod.dnom2, type = "response"))
  
  #  Numérateur du poids
  
  mod.num1 = glm(a_0~1,family=binomial(link="logit"));
  num1 = ifelse(a_0== 0, 1-predict(mod.num1, type = "response"),
                predict(mod.num1, type = "response"))
  
  mod.num2=glm(a_1~a_0,family=binomial(link="logit"));
  num2 = ifelse(a_1== 0, 1-predict(mod.num2, type = "response"),
                predict(mod.num2, type = "response"))
  
  mod.num3=glm(a_1~1,family=binomial(link="logit"));
  num3 = ifelse(a_1== 0, 1-predict(mod.num3, type = "response"),
                predict(mod.num3, type = "response"))
  ...
  mod.dnom1=glm(a_0~l_0+m_0+n_0+p_0+q_0,data = data.a,
                family=binomial(link="logit"))
  
  mod.dnom2=glm(a_1~l_0+m_0+n_0+p_0+q_0
                +l_1+m_1+n_1+p_1+q_1,data = data.a,
                family=binomial(link="logit"))
  ...
  mod.dnom2=glm(a_1~l_0+m_0+n_0+p_0+q_0+l_1+m_1+n_1+p_1+q_1,
                data = data.a,weights=wtx1_1,family=binomial(link="logit"))
  ...
  mod.dnom2=glm(a_1~l_0+m_0+n_0+p_0+q_0+l_1+
                  m_1+n_1+p_1+q_1,data = data.a,
                weights=wtx2_1,family=binomial(link="logit"))
