##################################################################################################################################
#  Scénario 2 de l'article de Franklin en utilisant le DAG de l'article
# de Matthew Sperrin dans le cas de deux temps de mesure. 

#  J'ai utilisé une taille d'échantillon de n=10000 et choisi des valeurs 
...
# d'environ 20%.
#
# Dans ce scénario, des termes non linéaires et 
# d'interaction étaient présents dans le modèle générateur de résultat
#                                                                     
###################################################################################################################################
...
l_0 = as.numeric(rnorm(n,0,1)); 
m_0 = as.numeric(rlnorm(n,0,0.5)); 
n_0 = as.numeric(rnorm(n,0,10)) ; 
o_0 = as.numeric(rbinom(n,1,plogis(-0.05+2*l_0))); 
p_0 = as.numeric(rbinom(n,1,0.2)); 
q_0 = as.numeric(sample(c(1,2,3,4,5),n,replace=TRUE,c(0.5,0.3,0.1,0.05,0.05))); 
...
a_0 = as.numeric(rbinom(n,1,plogis(-1.3+0.05*l_0+0.05*m_0+0.1*n_0+0.75*o_0+0.5*p_0+0.4*q_0)));
...
a_1 = as.numeric(rbinom(n,size=1,plogis(-1.7+0.69*a_0+0.05*l_1+0.05*m_1+0.1*n_1+0.75*o_1+0.5*p_1+0.4*q_1)));
...
Y = as.numeric(rbinom(n,size=1,plogis(-3.1-0.69*a_0+0.4*l_0+0.03*m_0
                                      +0.03*n_0+0.75*o_0+0.75*p_0+0.2*q_0
                                      -0.69*a_1+0.4*l_1+0.03*m_1+0.03*n_1
                                      +0.75*o_1+0.75*p_1+0.2*q_1
                                      +0.4*r_0+0.02*u_0+0.04*v_0+0.5*t_0+
                                        0.4*r_1+0.02*u_1+0.04*v_1+0.5*t_1)));


l_1.0=as.numeric(rnorm(n,-1*0,1));
l_1.1=as.numeric(rnorm(n,-1*1,1));
...
o_1.0=as.numeric(rbinom(n,1,plogis(1.23+2*l_1.0-0.5*0)));
o_1.1=as.numeric(rbinom(n,1,plogis(1.23+2*l_1.1-0.5*1)));

p_1.0=as.numeric(rbinom(n,1,plogis(-1.1-0.75*0)));
p_1.1=as.numeric(rbinom(n,1,plogis(-1.1-0.75*1)));
...
Y.00 = as.numeric(rbinom(n,size=1,plogis(-3.1-0.69*0+0.4*l_0+0.03*m_0
                                         +0.03*n_0+0.75*o_0+0.75*p_0+0.2*q_0
                                         -0.69*0+0.4*l_1.0+0.03*m_1.0+0.03*n_1.0
                                         +0.75*o_1.0+0.75*p_1.0+0.2*q_1
                                         +0.4*r_0+0.02*u_0+0.04*v_0+0.5*t_0+
                                           0.4*r_1.0+0.02*u_1.0+0.04*v_1.0+0.5*t_1.0)));


Y.01 = as.numeric(rbinom(n,size=1,plogis(-3.1-0.69*0+0.4*l_0+0.03*m_0
                                         +0.03*n_0+0.75*o_0+0.75*p_0+0.2*q_0
                                         -0.69*1+0.4*l_1.0+0.03*m_1.0+0.03*n_1.0
                                         +0.75*o_1.0+0.75*p_1.0+0.2*q_1
                                         +0.4*r_0+0.02*u_0+0.04*v_0+0.5*t_0+
                                           0.4*r_1.0+0.02*u_1.0+0.04*v_1.0+0.5*t_1.0)));

Y.10 = as.numeric(rbinom(n,size=1,plogis(-3.1-0.69*1+0.4*l_0+0.03*m_0
                                         +0.03*n_0+0.75*o_0+0.75*p_0+0.2*q_0
                                         -0.69*0+0.4*l_1.1+0.03*m_1.1+0.03*n_1.1
                                         +0.75*o_1.1+0.75*p_1.1+0.2*q_1
                                         +0.4*r_0+0.02*u_0+0.04*v_0+0.5*t_0+
                                           0.4*r_1.1+0.02*u_1.1+0.04*v_1.1+0.5*t_1.1)));

Y.11 = as.numeric(rbinom(n,size=1,plogis(-3.1-0.69*1+0.4*l_0+0.03*m_0
                                         +0.03*n_0+0.75*o_0+0.75*p_0+0.2*q_0
                                         -0.69*1+0.4*l_1.1+0.03*m_1.1+0.03*n_1.1
                                         +0.75*o_1.1+0.75*p_1.1+0.2*q_1
                                         +0.4*r_0+0.02*u_0+0.04*v_0+0.5*t_0+
                                           0.4*r_1.1+0.02*u_1.1+0.04*v_1.1+0.5*t_1.1)));
...
for(i in 1:B){
  ...
  data.a= data.frame(id,a_0,a_1,l_0,l_1,m_0,m_1,n_0,n_1,o_0,o_1,p_0,
                     p_1,q_0,q_1,r_0,r_1,u_0,u_1,v_0,v_1,t_0,t_1,
                     wtx_0,wtx_1,wtx1_0,wtx1_1,wtx2_0,
                     wtx2_1,wtx3_0,wtx3_1,swax_0,swax_1,W,Y)
  ...
  data.b=my.lengthen(
    ...
    exposure="a", 
    temporal.covariate=c("l","m","n","o","p","q","r","u","v","t")
  )
  ...
  mytable=my.balance(
    ...
    loop="yes",
    metric="SMD",
    sort.order= c("l","m","n","o","p","q","r","u","v","t")
  )
  ...
  data.u=filter(data.c,name.cov=="u",time.covariate==0,time.exposure==0)
  data1.u=filter(data.c,name.cov=="u",time.covariate==0,time.exposure==1)
  data2.u=filter(data.c,name.cov=="u",time.covariate==1,time.exposure==1)
  ...
  LD=c(ld(data.l,6,7,5),ld(data.m,6,7,5),ld(data.n,6,7,5),ld(data.o,6,7,5),
       ld(data.p,6,7,5),ld(data.q,6,7,5),ld(data.r,6,7,5),ld(data.u,6,7,5),
       ld(data.v,6,7,5),ld(data.t,6,7,5),ld(data1.l,6,7,5),ld(data2.l,6,7,5),
       ld(data1.m,6,7,5),ld(data2.m,6,7,5),ld(data1.n,6,7,5),ld(data2.n,6,7,5),
       ld(data1.o,6,7,5),ld(data2.o,6,7,5),ld(data1.p,6,7,5),ld(data2.p,6,7,5),
       ld(data1.q,6,7,5), ld(data2.q,6,7,5),ld(data1.r,6,7,5), ld(data2.r,6,7,5),
       ld(data1.u,6,7,5), ld(data2.u,6,7,5),ld(data1.v,6,7,5), ld(data2.v,6,7,5),
       ld(data1.t,6,7,5), ld(data2.t,6,7,5));
  
  # Tableau récapitutlatif
  
  time.exposure=as.numeric(c(rep(0,10),rep(1,20)));
  time.covariate=as.numeric(c(rep(0,10),rep(c(0,1),10)));
  ...
  covs=select(data.a,l_0,m_0,n_0,o_0,p_0,q_0,r_0,u_0,v_0,t_0)
  trt=data.a$a_0
  weight=data.a$W
  ...
  covs=select(data.a,l_1,m_1,n_1,o_1,p_1,q_1,r_1,u_1,v_1,t_1)
  trt=data.a$a_1
  weight=data.a$W
  ...
  weight=data.a$W
  dat=select(data.a,l_0,m_0,n_0,o_0,p_0,q_0,r_0,u_0,v_0,t_0,a_0)
  trt=dat$a_0
  mean.GWD[i]=gwd(dat,10, trt, weight)
  ...
  weight=data.a$W
  dat=select(data.a,l_0,m_0,n_0,o_0,p_0,q_0,r_0,u_0,v_0,t_0,a_1)
  trt=dat$a_1
  mean.GWD1[i]=gwd(dat,10, trt, weight);
  
  # Pour les covariables X1
  
  weight=data.a$W
  dat=select(data.a,l_1,m_1,n_1,o_1,p_1,q_1,r_1,u_1,v_1,t_1,a_1)
  trt=dat$a_1
  mean.GWD2[i]=gwd(dat,10, trt, weight);  
  ...
  data.u=filter(mydata.a,name.cov=="u",time.covariate==0,time.exposure==0)
  data1.u=filter(mydata.a,name.cov=="u",time.covariate==0,time.exposure==1)
  data2.u=filter(mydata.a,name.cov=="u",time.covariate==1,time.exposure==1)
  ...
  dat=select(data.a,l_0,m_0,n_0,o_0,p_0,q_0,r_0,u_0,v_0,t_0,a_0)
  trt=dat$a_0
  mean.GWD3[i]=gwd(dat,10, trt, weight)
  
  weight=data.a$wtx_1
  dat=select(data.a,l_0,m_0,n_0,o_0,p_0,q_0,r_0,u_0,v_0,t_0,a_1)
  trt=dat$a_1
  mean.GWD4[i]=gwd(dat,10, trt, weight);
  
  weight=data.a$wtx_1
  dat=select(data.a,l_1,m_1,n_1,o_1,p_1,q_1,r_1,u_1,v_1,t_1,a_1)
  trt=dat$a_1
  mean.GWD5[i]=gwd(dat,10, trt, weight);
  
  ## Statistique C
  
  # Calcul du score de propension dans les données pondérées
  
  mod.dnom1=glm(a_0~l_0+m_0+n_0+o_0+p_0+q_0+r_0+u_0+v_0+t_0,data = data.a,weights=wtx_1,family=binomial(link="logit"))
  mod.dnom2=glm(a_1~l_0+m_0+n_0+o_0+p_0+q_0+r_0+u_0+v_0+t_0+l_1+m_1+n_1+o_1+p_1+q_1+r_1+u_1+v_1+t_1,data = data.a,weights=wtx_1,family=binomial(link="logit"))
  ...
  data.u=filter(mydata.b,name.cov=="u",time.covariate==0,time.exposure==0)
  data1.u=filter(mydata.b,name.cov=="u",time.covariate==0,time.exposure==1)
  data2.u=filter(mydata.b,name.cov=="u",time.covariate==1,time.exposure==1)
  ...
  dat=select(data.a,l_0,m_0,n_0,o_0,p_0,q_0,r_0,u_0,v_0,t_0,a_0)
  trt=dat$a_0
  mean.GWD6[i]=gwd(dat,10, trt, weight)
  
  weight=data.a$wtx1_1
  dat=select(data.a,l_0,m_0,n_0,o_0,p_0,q_0,r_0,u_0,v_0,t_0,a_1)
  trt=dat$a_1
  mean.GWD7[i]=gwd(dat,10, trt, weight);
  
  weight=data.a$wtx1_1
  dat=select(data.a,l_1,m_1,n_1,o_1,p_1,q_1,r_1,u_1,v_1,t_1,a_1)
  trt=dat$a_1
  mean.GWD8[i]=gwd(dat,10, trt, weight);
  
  # Statistique C
  
  # Calcul du score de propension dans les données pondérées
  
  mod.dnom1=glm(a_0~l_0+m_0+n_0+o_0+p_0+q_0+r_0+u_0+v_0+t_0,data = data.a,weights=wtx1_1,family=binomial(link="logit"))
  mod.dnom2=glm(a_1~l_0+m_0+n_0+o_0+p_0+q_0+r_0+u_0+v_0+t_0+l_1+m_1+n_1+o_1+p_1+q_1+r_1+u_1+v_1+t_1,data = data.a,weights=wtx1_1,family=binomial(link="logit"))
  ...
  data.u=filter(mydata.c,name.cov=="u",time.covariate==0,time.exposure==0)
  data1.u=filter(mydata.c,name.cov=="u",time.covariate==0,time.exposure==1)
  data2.u=filter(mydata.c,name.cov=="u",time.covariate==1,time.exposure==1)
  ...
  dat=select(data.a,l_0,m_0,n_0,o_0,p_0,q_0,r_0,u_0,v_0,t_0,a_0)
  trt=dat$a_0
  mean.GWD9[i]=gwd(dat,10, trt, weight)
  
  weight=data.a$wtx2_1
  dat=select(data.a,l_0,m_0,n_0,o_0,p_0,q_0,r_0,u_0,v_0,t_0,a_1)
  trt=dat$a_1
  mean.GWD10[i]=gwd(dat,10, trt, weight);
  
  weight=data.a$wtx2_1
  dat=select(data.a,l_1,m_1,n_1,o_1,p_1,q_1,r_1,u_1,v_1,t_1,a_1)
  trt=dat$a_1
  mean.GWD11[i]=gwd(dat,10, trt, weight);
  
  # Statistique C
  
  # Calcul du score de propension dans les données pondérées
  
  mod.dnom1=glm(a_0~l_0+m_0+n_0+o_0+p_0+q_0+r_0+u_0+v_0+t_0,data = data.a,weights=wtx2_1,family=binomial(link="logit"))
  mod.dnom2=glm(a_1~l_0+m_0+n_0+o_0+p_0+q_0+r_0+u_0+v_0+t_0+l_1+m_1+n_1+o_1+p_1+q_1+r_1+u_1+v_1+t_1,data = data.a,weights=wtx2_1,family=binomial(link="logit"))
  ...
  data.u=filter(mydata.d,name.cov=="u",time.covariate==0,time.exposure==0)
  data1.u=filter(mydata.d,name.cov=="u",time.covariate==0,time.exposure==1)
  data2.u=filter(mydata.d,name.cov=="u",time.covariate==1,time.exposure==1)
  ...
  dat=select(data.a,l_0,m_0,n_0,o_0,p_0,q_0,r_0,u_0,v_0,t_0,a_0)
  trt=dat$a_0
  mean.GWD12[i]=gwd(dat,10, trt, weight)
  
  weight=data.a$wtx3_1
  dat=select(data.a,l_0,m_0,n_0,o_0,p_0,q_0,r_0,u_0,v_0,t_0,a_1)
  trt=dat$a_1
  mean.GWD13[i]=gwd(dat,10, trt, weight);
  
  weight=data.a$wtx3_1
  dat=select(data.a,l_1,m_1,n_1,o_1,p_1,q_1,r_1,u_1,v_1,t_1,a_1)
  trt=dat$a_1
  mean.GWD14[i]=gwd(dat,10, trt, weight);
  
  # Statistique C
  
  # Calcul du score de propension dans les données pondérées
  
  mod.dnom1=glm(a_0~l_0+m_0+n_0+o_0+p_0+q_0+r_0+u_0+v_0+t_0,data = data.a,weights=wtx3_1,family=binomial(link="logit"))
  mod.dnom2=glm(a_1~l_0+m_0+n_0+o_0+p_0+q_0+r_0+u_0+v_0+t_0+l_1+m_1+n_1+o_1+p_1+q_1+r_1+u_1+v_1+t_1,data = data.a,weights=wtx3_1,family=binomial(link="logit"))
  ...
  data.u=filter(mydata.e,name.cov=="u",time.covariate==0,time.exposure==0)
  data1.u=filter(mydata.e,name.cov=="u",time.covariate==0,time.exposure==1)
  data2.u=filter(mydata.e,name.cov=="u",time.covariate==1,time.exposure==1)
  ...
  dat=select(data.a,l_0,m_0,n_0,o_0,p_0,q_0,r_0,u_0,v_0,t_0,a_0)
  trt=dat$a_0
  mean.GWD15[i]=gwd(dat,10, trt, weight)
  
  weight=data.a$swax_1
  dat=select(data.a,l_0,m_0,n_0,o_0,p_0,q_0,r_0,u_0,v_0,t_0,a_1)
  trt=dat$a_1
  mean.GWD16[i]=gwd(dat,10, trt, weight);
  
  weight=data.a$swax_1
  dat=select(data.a,l_1,m_1,n_1,o_1,p_1,q_1,r_1,u_1,v_1,t_1,a_1)
  trt=dat$a_1
  mean.GWD17[i]=gwd(dat,10, trt, weight);
  ...
  # Fit weighted model
  lmfit=glm(as.factor(Y)~as.factor(a_0)+as.factor(a_1),weights=swax_1,data=data.a,family=binomial(link="logit"))
