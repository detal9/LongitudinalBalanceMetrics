##################################################################################################################################
#  Scénario 4 de l'article de Franklin en utilisant le DAG de l'article
...
# d'environ 20%.
#
# Dans ce scénario, les covariables l et o sont  fortement corrélées 
# (comme dans tous les scénarios de simulation), 
# mais seul l avait un effet direct sur l'exposition ou le résultat.
#                                                                     
###################################################################################################################################
...
a_0 = as.numeric(rbinom(n,1,plogis(-0.37+0.2*l_0+0.03*m_0+0.02*n_0+
                                     1.5*p_0+0.01*q_0+0.01*r_0+0.02*u_0)));
...
a_1 = as.numeric(rbinom(n,size=1,plogis(-0.59+0.69*a_0+0.2*l_1+0.03*m_1+
                                          0.02*n_1+1.5*p_1+0.01*q_1
                                        +0.01*r_1+0.02*u_1)));

Y = as.numeric(rbinom(n,size=1,plogis(-2-0.69*a_0+0.4*l_0+0.03*m_0
                                      +0.03*n_0+0.75*p_0+0.2*q_0
                                      -0.69*a_1+0.4*l_1+0.03*m_1+0.03*n_1
                                      +0.75*p_1+0.2*q_1+0.4*r_0+0.02*u_0+
                                        0.4*r_1+0.02*u_1)));
...
Y.00 = as.numeric(rbinom(n,size=1,plogis(-2-0.69*0+0.4*l_0+0.03*m_0
                                         +0.03*n_0+0.75*p_0+0.2*q_0
                                         -0.69*0+0.4*l_1.0+0.03*m_1.0+0.03*n_1.0
                                         +0.75*p_1.0+0.2*q_1+0.4*r_0+0.02*u_0+
                                           0.4*r_1.0+0.02*u_1.0)));


Y.01 = as.numeric(rbinom(n,size=1,plogis(-2-0.69*0+0.4*l_0+0.03*m_0
                                         +0.03*n_0+0.75*p_0+0.2*q_0
                                         -0.69*1+0.4*l_1.0+0.03*m_1.0+0.03*n_1.0
                                         +0.75*p_1.0+0.2*q_1+0.4*r_0+0.02*u_0+
                                           0.4*r_1.0+0.02*u_1.0)));

Y.10 = as.numeric(rbinom(n,size=1,plogis(-2-0.69*1+0.4*l_0+0.03*m_0
                                         +0.03*n_0+0.75*p_0+0.2*q_0
                                         -0.69*0+0.4*l_1.1+0.03*m_1.1+0.03*n_1.1
                                         +0.75*p_1.1+0.2*q_1+0.4*r_0+0.02*u_0+
                                           0.4*r_1.1+0.02*u_1.1)));

Y.11 = as.numeric(rbinom(n,size=1,plogis(-2-0.69*1+0.4*l_0+0.03*m_0
                                         +0.03*n_0+0.75*p_0+0.2*q_0
...
for(i in 1:B){
  ...
  data.b=my.lengthen(data.a,id="id",
                     ...
                     exposure="a", 
                     temporal.covariate=c("l","m","n","p","q","r","u"))
  ...
  LD=c(ld(data.l,6,7,5),ld(data.m,6,7,5),ld(data.n,6,7,5),
       ld(data.p,6,7,5),ld(data.q,6,7,5),ld(data.r,6,7,5),
       ld(data.u,6,7,5),ld(data1.l,6,7,5),ld(data2.l,6,7,5),
       ld(data1.m,6,7,5),ld(data2.m,6,7,5),ld(data1.n,6,7,5),
       ld(data2.n,6,7,5),ld(data1.p,6,7,5),ld(data2.p,6,7,5),
       ld(data1.q,6,7,5), ld(data2.q,6,7,5),ld(data1.r,6,7,5), 
       ld(data2.r,6,7,5),ld(data1.u,6,7,5), ld(data2.u,6,7,5));
  
  # Tableau récapitutlatif
  
  time.exposure=as.numeric(c(rep(0,7),rep(1,14)));
  time.covariate=as.numeric(c(rep(0,7),rep(c(0,1),7)));
  mytable=data.frame(time.exposure,time.covariate,LD);
  ...
  covs=select(data.a,l_0,m_0,n_0,p_0,q_0,r_0,u_0)
  trt=data.a$a_0
  weight=data.a$W
  ...
  covs=select(data.a,l_1,m_1,n_1,p_1,q_1,r_1,u_1)
  trt=data.a$a_1
  weight=data.a$W
  ...
  weight=data.a$W
  dat=select(data.a,l_0,m_0,n_0,p_0,q_0,r_0,u_0,a_0)
  trt=dat$a_0
  mean.GWD[i]=gwd(dat,7, trt, weight)
  ...
  weight=data.a$W
  dat=select(data.a,l_0,m_0,n_0,p_0,q_0,r_0,u_0,a_1)
  trt=dat$a_1
  mean.GWD1[i]=gwd(dat,7, trt, weight);
  
  # Pour les covariables X1
  
  weight=data.a$W
  dat=select(data.a,l_1,m_1,n_1,p_1,q_1,r_1,u_1,a_1)
  trt=dat$a_1
  mean.GWD2[i]=gwd(dat,7, trt, weight);  
  ...
  dat=select(data.a,l_0,m_0,n_0,p_0,q_0,r_0,u_0,a_0)
  trt=dat$a_0
  mean.GWD3[i]=gwd(dat,7, trt, weight)
  
  weight=data.a$wtx_1
  dat=select(data.a,l_0,m_0,n_0,p_0,q_0,r_0,u_0,a_1)
  trt=dat$a_1
  mean.GWD4[i]=gwd(dat,7, trt, weight);
  
  weight=data.a$wtx_1
  dat=select(data.a,l_1,m_1,n_1,p_1,q_1,r_1,u_1,a_1)
  trt=dat$a_1
  mean.GWD5[i]=gwd(dat,7, trt, weight);
  ...
  dat=select(data.a,l_0,m_0,n_0,p_0,q_0,r_0,u_0,a_0)
  trt=dat$a_0
  mean.GWD6[i]=gwd(dat,7, trt, weight)
  
  weight=data.a$wtx1_1
  dat=select(data.a,l_0,m_0,n_0,p_0,q_0,r_0,u_0,a_1)
  trt=dat$a_1
  mean.GWD7[i]=gwd(dat,7, trt, weight);
  
  weight=data.a$wtx1_1
  dat=select(data.a,l_1,m_1,n_1,p_1,q_1,r_1,u_1,a_1)
  trt=dat$a_1
  mean.GWD8[i]=gwd(dat,7, trt, weight);
  ...
  dat=select(data.a,l_0,m_0,n_0,p_0,q_0,r_0,u_0,a_0)
  trt=dat$a_0
  mean.GWD9[i]=gwd(dat,7, trt, weight)
  
  weight=data.a$wtx2_1
  dat=select(data.a,l_0,m_0,n_0,p_0,q_0,r_0,u_0,a_1)
  trt=dat$a_1
  mean.GWD10[i]=gwd(dat,7, trt, weight);
  
  weight=data.a$wtx2_1
  dat=select(data.a,l_1,m_1,n_1,p_1,q_1,r_1,u_1,a_1)
  trt=dat$a_1
  mean.GWD11[i]=gwd(dat,7, trt, weight);
  ...
  dat=select(data.a,l_0,m_0,n_0,p_0,q_0,r_0,u_0,a_0)
  trt=dat$a_0
  mean.GWD12[i]=gwd(dat,7, trt, weight)
  
  weight=data.a$wtx3_1
  dat=select(data.a,l_0,m_0,n_0,p_0,q_0,r_0,u_0,a_1)
  trt=dat$a_1
  mean.GWD13[i]=gwd(dat,7, trt, weight);
  
  weight=data.a$wtx3_1
  dat=select(data.a,l_1,m_1,n_1,p_1,q_1,r_1,u_1,a_1)
  trt=dat$a_1
  mean.GWD14[i]=gwd(dat,7, trt, weight);
  ...
  LD=c(ld(data.l,6,7,5),ld(data.m,6,7,5),ld(data.n,6,7,5),
       ...
       ld(data1.l,6,7,5),ld(data2.l,6,7,5),ld(data1.m,6,7,5),ld(data2.m,6,7,5),
       ld(data1.n,6,7,5),ld(data2.n,6,7,5),ld(data1.p,6,7,5),ld(data2.p,6,7,5),
       ld(data1.q,6,7,5), ld(data2.q,6,7,5),ld(data1.r,6,7,5),
       ld(data2.r,6,7,5),ld(data1.u,6,7,5), ld(data2.u,6,7,5));
  ...
  dat=select(data.a,l_0,m_0,n_0,p_0,q_0,r_0,u_0,a_0)
  trt=dat$a_0
  mean.GWD15[i]=gwd(dat,7, trt, weight)
  
  weight=data.a$swax_1
  dat=select(data.a,l_0,m_0,n_0,p_0,q_0,r_0,u_0,a_1)
  trt=dat$a_1
  mean.GWD16[i]=gwd(dat,7, trt, weight);
  
  weight=data.a$swax_1
  dat=select(data.a,l_1,m_1,n_1,p_1,q_1,r_1,u_1,a_1)
  trt=dat$a_1
  mean.GWD17[i]=gwd(dat,7, trt, weight);
